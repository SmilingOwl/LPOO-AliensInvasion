...
public class ComsumableBody extends EntityBody {
    public ComsumableBody(World world, ComsumableModel model){
       ...
       //setTypeToStatic();
        ...
        createFixture(body, new float[]{ 10,10,40,10,40,40,10,40,}, width, height,density, friction,restitution,CONSUMABLE_BODY,(short)( PLATAFORMS_BODY|ALIEN_BODY|HERO_BODY));
    }
}
