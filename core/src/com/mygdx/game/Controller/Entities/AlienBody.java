...
public class AlienBody extends EntityBody {
    public AlienBody(World world, AlienModel model){
       ...
       // setTypeToStatic();
        ...
        createFixture(body, new float[]{ 37,7,29,23,17,39,10,48,12,60,67,60,67,40,47,7},width,height,density,friction,restitution,ALIEN_BODY,(short)(HERO_BODY| PLATAFORMS_BODY));
    }
}
